...
def get_safe_db_uri():
    ...
    if raw_url:
        try:
            ...
            log.warning(f"⚠️ Invalid DATABASE_URL ({e}). Using SQLite fallback.")
...
try:
    ...
    log.error(f"Error loading models or blueprint: {e}")
...
def run_telegram_bot():
    ...
    try:
        ...
        from models import db, BotUser, Signal, ActivityLog, ActivationCode
